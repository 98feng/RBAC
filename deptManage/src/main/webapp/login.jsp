...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
        DEPTMAG &nbsp;<span style="font-size: 12px;">&copy;高明峰少</span></div>
</div>

<div style="position: absolute; top: 120px; right: 450px;width:450px;height:400px;border:0px solid #D5D5D5">
    <div style="position: absolute; top: 0px; right: 60px;">
        <div class="page-header">
            <h1>登录 或 注册</h1>
        </div>
        <form service="workbench/index.jsp" class="form-horizontal" role="form">
