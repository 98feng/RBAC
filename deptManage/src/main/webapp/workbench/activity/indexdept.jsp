...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#addBtn").click(function () {
                ...
                $.ajax({
                    ...
                    url: "workbench/deptActivity/getUserList.do",
                    type: "get",
                    dataType: "json",
            ...
            $("#saveBtn").click(function () {
                ...
                $.ajax({
                    ...
                    url: "workbench/deptActivity/creatActivity.do",
                    data: {

                        "owner": $.trim($("#create-owner").val()),
                        "deptno": $.trim($("#create-deptno").val()),
                        "dname": $.trim($("#create-dname").val()),
                        "loc": $.trim($("#create-loc").val()),
            ...
            $("#searchBtn").click(function () {
                ...
                $("#hidden-dname").val($.trim($("#search-dname").val()));
                $("#hidden-loc").val($.trim($("#search-loc").val()));
            ...
            $("#deleteBtn").click(function () {
                ...
                if ($xz.length === 0) {
                    ...
                    if (confirm("确定删除所选中的记录吗？")) {
                        ...
                        //url:workbench/deptActivity/delete.do?id=xxx&id=xxx&id=xxx
                        ...
                        $.ajax({
                            ...
                            url: "workbench/deptActivity/delete.do",
                            data: param,
                            type: "post",
                            dataType: "json",
                            success: function (data) {
            ...
            $("#editBtn").click(function () {
                ...
                if ($xz.length == 0) {
                    ...
                    $.ajax({
                        ...
                        url: "workbench/deptActivity/getUserListAndActivity.do",
                        data: {
            ...
            $("#updateBtn").click(function () {
                ...
                $.ajax({
                    ...
                    url: "workbench/deptActivity/update.do",
                    data: {
        ...
        function pageList(pageNo, pageSize) {
            ...
            $("#search-dname").val($.trim($("#hidden-dname").val()));
            $("#search-loc").val($.trim($("#hidden-loc").val()));
            $("#search-startDate").val($.trim($("#hidden-startDate").val()));
            $("#search-endDate").val($.trim($("#hidden-endDate").val()));

            $.ajax({

                url: "workbench/deptActivity/pageList.do",
                data: {
                    ...
                    "dname": $.trim($("#search-dname").val()),
                    "loc": $.trim($("#search-loc").val()),
                ...
                success: function (data) {
                    ...
                    $.each(data.dataList, function (i, n) {
                        ...
                        html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/deptActivity/detail.do?id=' + n.id + '\';">' + n.deptno + '</a></td>';
                        html += '<td>' + n.owner + '</td>';
                        html += '<td>' + n.dname + '</td>';
                        html += '<td>' + n.loc + '</td>';
...
<input type="hidden" id="hidden-dname"/>
<input type="hidden" id="hidden-loc"/>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <br>
                        <br>
                        <label class="col-sm-2 control-label">部门名称<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
            ...
            <div class="modal-body">
                ...
                <form id="activityAddForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-2 control-label">部门编号<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                        ...
                        <label  class="col-sm-2 control-label">部门位置</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-loc">
                        </div>
            ...
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <div class="input-group-addon">部门编号</div>
                        <input class="form-control" type="text" id="search-deptno">
                        <div class="input-group-addon">部门名称</div>
                        <input class="form-control" type="text" id="search-dname">
                        <div class="input-group-addon">部门位置</div>
                        <input class="form-control" type="text" id="search-loc">
        ...
        <div style="position: relative;top: 10px;">
            <table class="table table-hover">
                ...
                <%--<tr class="active">
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/deptActivity/detaildept.jsp';">发传单</a></td>
                    <td>zhangsan</td>
                    <td>2020-10-10</td>
                    <td>2020-10-20</td>
                </tr>
                <tr class="active">
                    <td><input type="checkbox" /></td>
                    <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detaildept.jsp';">发传单</a></td>
                    <td>zhangsan</td>
                    <td>2020-10-10</td>
                    <td>2020-10-20</td>
                </tr>--%>
