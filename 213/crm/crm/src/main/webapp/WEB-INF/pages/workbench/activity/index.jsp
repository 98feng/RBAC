...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateActivityBtn").click(function () {
			...
			var regExp= /^(([1-9]\d*)|0)$/;
			if (!regExp.test(cost)){ //true -100 false true
				//-100
				alert("成本只能是非负整数");
				return;
			}
		...
		$("#importActivityBtn").click(function () {
			...
			$.ajax({
				...
				type:'post',
				dataType:'json',
				processData:false, //在默认请求下，ajax向后台传数据时，会把所有的参数统一转成字符串，因为file
				contentType:false,//设置编码 urlencoded编码，因为file,不用设置
				success:function(data){
					//1 0
					if(data.code=="1"){
        ...
        $.ajax({
            ...
            success:function (data) {
               ...
               $.each(data.activityList,function (index,obj) {
                ...
                //计算总页数
                var totalPages=1; //data.totalRows=51/10=6
